...
<dl>
    ...
    <dt>B</dt>
    <dd>9.85KB minified, 4.85KB minified and gzipped.</dd>
    <dt>C</dt>
...
## Quick Start
Vibe JavaScript Client is distributed at two places according to runtime engine: browser version through this web site in [compressed](/projects/vibe-javascript-client/3.0.0-Alpha10/vibe.min.js) and [uncompressed](/projects/vibe-javascript-client/3.0.0-Alpha10/vibe.js) forms and node version through npm.
...
* To take a brief look at API, check out the [testee](https://github.com/vibe-project/vibe-javascript-client/blob/v3.0.0-Alpha10/Gruntfile.js#L61-L91).
* To get details of API, see [API document](/projects/vibe-javascript-client/3.0.0-Alpha10/api/).
* To have a thorough knowledge of the implementation, read out the [reference](/projects/vibe-javascript-client/3.0.0-Alpha10/reference/).