...
Because I'm not familiar with Scala, I used Play's Java API. Be aware of package name when importing class and note there are some quirks in [PlayServerHttpExchange]({{ site.baseurl }}/documentation/0.1.2/apidocs/io/github/flowersinthesand/wes/play/PlayServerHttpExchange.html).
